...
try
{
    ...
    Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3307/employee","root", "sjhs");
    ...
    String str="insert into Employee values("+Empno+", "+"'"+EName+"'"+", "+"'"+Job+"' ,"+"'"+Hiredate+"' ,"+Salary+","+Comm+", "+Deptno+")"+";";
